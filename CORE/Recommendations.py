...
recom['SMA'] = list(map(lambda x: plot_SMA(300, x)[0], stock))
recom['twoSMA'] = list(map(lambda x: plot_twoSMA(300, x)[0], stock))
recom['EMA'] = list(map(lambda x: plot_EMA(300, x)[0], stock))
recom['DEMA'] = list(map(lambda x: plot_DEMA(300, x)[0], stock))
recom['TEMA'] = list(map(lambda x: plot_TEMA(300, x)[0], stock))
recom['MACD'] = list(map(lambda x: plot_MACD(300, x)[0], stock))
recom['CHV'] = list(map(lambda x: plot_CHV(300, x)[0], stock))
recom['RSI'] = list(map(lambda x: plot_RSI(300, x)[0], stock))
recom['bulls'] = list(map(lambda x: plot_bulls(300, x)[0], stock))
recom['bears'] = list(map(lambda x: plot_bears(300, x)[0], stock))
recom['ER'] = list(map(lambda x: plot_ER(300, x)[0], stock))
